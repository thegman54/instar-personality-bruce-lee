-- Personality Bruce Lee: Core traits table
...
CREATE TABLE IF NOT EXISTS personality_bruce_lee_traits (
...
CREATE INDEX IF NOT EXISTS idx_pbl_traits_profile_cat
    ON personality_bruce_lee_traits(profile_slug, category);
CREATE INDEX IF NOT EXISTS idx_pbl_traits_profile_layer
    ON personality_bruce_lee_traits(profile_slug, layer);
CREATE INDEX IF NOT EXISTS idx_pbl_traits_profile_weight
    ON personality_bruce_lee_traits(profile_slug, weight DESC);
CREATE INDEX IF NOT EXISTS idx_pbl_traits_tags
    ON personality_bruce_lee_traits USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_pbl_traits_examples
    ON personality_bruce_lee_traits USING GIN(examples);
