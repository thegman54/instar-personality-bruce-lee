...
@register_tool
class PersonalityBruceLeeListTool(BaseTool):
    """List available personality categories and data store counts."""

    @property
    def name(self) -> str:
        return "personality_bruce_lee_list"
    ...
    def description(self) -> str:
        return (
            ...
            "and reaction pattern counts. Use before personality_bruce_lee_read "
        ...
        try:
            async with pool.acquire() as conn:
                ...
                quote_count = await conn.fetchval(
                    "SELECT COUNT(*) FROM personality_bruce_lee_quotes WHERE profile_slug = $1",
                    profile_slug,
                )
            ...
            log.error("personality_bruce_lee_list_error", error=str(e))
