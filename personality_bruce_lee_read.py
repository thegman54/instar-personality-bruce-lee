"""
personality_bruce_lee_read — retrieve personality data across all four stores.
...
@register_tool
class PersonalityBruceLeeReadTool(BaseTool):
    """Load Bruce Lee personality traits, quotes, lexicon, and reactions."""

    @property
    def name(self) -> str:
        return "personality_bruce_lee_read"

    @property
    def description(self) -> str:
        return (
            "Load Bruce Lee personality data for the given categories. "
    ...
    async def execute(
        ...
        **kwargs,
        ...
        log.info("personality_bruce_lee_read",
        ...
        try:
            ...
            try:
                ...
                await log_tool_activity(
                    tool_name="personality_bruce_lee_read",
            ...
            log.error("personality_bruce_lee_read_error", error=str(e))
